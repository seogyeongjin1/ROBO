...
public class WaitRoom_NewRoom_Panel extends JPanel{
   ...
   public WaitRoom_NewRoom_Panel() {
      setLayout(null);
      back = Toolkit.getDefaultToolkit().getImage("C:\\javaDev\\프로젝트그림\\loginback.jpg");
      ...
      okButtonIcon=new ImageIcon("C:\\javaDev\\프로젝트그림\\btn_ok.jpg");
      noButtonIcon=new ImageIcon("C:\\javaDev\\프로젝트그림\\btn_cancel.jpg");
